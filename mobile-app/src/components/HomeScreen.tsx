...
const GOOGLE_MAPS_API_KEY =
  process.env.EXPO_PUBLIC_GOOGLE_MAPS_API_KEY || "[GCP_API_KEY]";
...
export default function HomeScreen({
  ...
  const userName =
    user?.backendUser?.user?.name || user?.googleData?.user?.name || "Ali";
  const userPhoto =
    user?.backendUser?.user?.photo ||
    user?.googleData?.user?.photo ||
    "https://lh3.googleusercontent.com/aida-public/AB6AXuA_MXCjwGeq0GUiyK3WW6t6yqZ7TxAls0iXWQo8vCl7kmNU4HlRa0WceleGvbd1HJOROkvw5ow3lgtyXVGfS75uzsj4d-AyEoRN4SJLRiPDktmx2t1xPDrYq_q539mk4c9cYjpY4ljvJ5U03Ge1HUsRfQ6a0L3KmtJtJPCVDURdK4qJ9naUuM7h5YWxkAmGOTqN2nlM-qWh-x2H-_QR-9Dk_JBlTSSw3hUmA7D072attkBMp282axpaR5KyYW0DTyXZVsYO9JAkpmc";
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      description:
        "Your technician, Ali Khan, has confirmed the appointment for tomorrow at 10:00 AM.",
      time: "5 hours ago",
      icon: "check-circle",
      iconColor: "#005c3e",
    ...
    },
    {
      ...
      description:
        "Ali Khan has arrived at your location. Please guide him to the workspace.",
      time: "1 hour ago",
      icon: "room",
      iconColor: "#00595c",
    ...
    },
    {
      ...
      description:
        "The AC Repair service has been marked completed by Ali Khan. Please review the invoice and rate the service.",
      time: "10 mins ago",
      icon: "verified",
      iconColor: "#00595c",
      bgColor: "rgba(0, 89, 92, 0.08)",
  ...
  const fetchProvidersData = async (lat?: number, lng?: number) => {
    ...
    try {
      ...
      if (res && res.providers) {
        const validProviders = res.providers.filter(
          (p) =>
            p.latitude !== null &&
            p.longitude !== null &&
  ...
  const fetchBookings = async (filter?: string) => {
    ...
    try {
      const apiStatus = filterToApiStatus[currentFilter];
      const response = await getUserBookings(userId, apiStatus);
  ...
  }, [activeTab, userId, selectedFilter]);
  ...
  async function startSpeechRecognition() {
    ...
    try {
      if (sessionId !== activeSessionRef.current || isCancelledRef.current)
        return;
  ...
  return (
    <>
        ...
        {activeTab === "home" ? (
                      ...
                      onPress={() =>
                        router.push({
                          ...
                          params: {
                            ...
                            price: prov.hourly_rate
                              ? `Rs ${prov.hourly_rate} Base Fee`
                              : "Rs 1,200 Base Fee",
                          },
                        })
                      }
                ...
                {[
                  ...
                  >
                    ...
                    <View style={styles.menuItemRight}>
                      {item.trailing && (
                        <Text style={styles.menuItemTrailing}>
                          {item.trailing}
                        </Text>
                      )}
                      <MaterialIcons
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setConfirmDialog({
                  ...
                  title: "Log Out?",
                  message:
                    "Are you sure you want to log out of your Karigar.ai account?",
                  confirmText: "Log Out",
                  cancelText: "Cancel",
                  iconName: "logout",
                  iconColor: "#ba1a1a",
          ...
          <View style={styles.bookingsContainer}>
            ...
            <View style={styles.filterChipRow}>
              {["Upcoming", "Active", "Completed", "Cancelled"].map(
                (filterVal) => (
                  <TouchableOpacity
                    key={filterVal}
                    style={[
            ...
            <ScrollView
              contentContainerStyle={[
                ...
                (isLoadingBookings || getDisplayedBookings().length === 0) && {
                  flexGrow: 1,
                                  ...
                                  onConfirm: async () => {
                                    ...
                                    if (bAny.realId) {
                                      try {
                                        ...
                                        let errorMsg =
                                          "Unable to cancel your booking at this time. Please try again later.";
                                        if (
                                          err.message &&
                                          err.message.includes("API error 400")
                                        ) {
                                          try {
                                            const match =
                                              err.message.match(
                          ...
                          <>
                            ...
                            {booking.rated && (
                              ...
                              >
                                <Text
                                  style={[
                                    styles.actionBtnTextSec,
                                    { color: "#00595c", fontWeight: "bold" },
                                  ]}
                                >
                                  ★ Rated
                                </Text>
              ...
              {ratingBooking && (
                <>
                  ...
                  <View style={styles.ratingProviderCard}>
                    <Image
                      source={{
                        uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_MXCjwGeq0GUiyK3WW6t6yqZ7TxAls0iXWQo8vCl7kmNU4HlRa0WceleGvbd1HJOROkvw5ow3lgtyXVGfS75uzsj4d-AyEoRN4SJLRiPDktmx2t1xPDrYq_q539mk4c9cYjpY4ljvJ5U03Ge1HUsRfQ6a0L3KmtJtJPCVDURdK4qJ9naUuM7h5YWxkAmGOTqN2nlM-qWh-x2H-_QR-9Dk_JBlTSSw3hUmA7D072attkBMp282axpaR5KyYW0DTyXZVsYO9JAkpmc",
                      }}
                      style={styles.ratingAvatar}
                    />
                    <Text style={styles.ratingProviderName}>
                      {ratingBooking.provider === "Assigning Provider..."
                        ? "Ahmed Hassan"
                        : ratingBooking.provider}
                    </Text>
                    <Text style={styles.ratingProviderSub}>
                      {ratingBooking.providerDetail ===
                      "Assigning AC Technician"
                        ? "Expert AC Technician • Service ID #4829"
                        : ratingBooking.providerDetail}
                    </Text>
                  ...
                  >
                    <View style={styles.ratingInsightHeader}>
                      <MaterialIcons
                        ...
                        color="#00595c"
                      />
                      <Text style={styles.ratingInsightTitle}>
                        KARIGAR INSIGHT
                      </Text>
                    </View>
                    <Text style={styles.ratingInsightBody}>
                      Ahmed completed the service in{" "}
                      <Text style={{ fontFamily: "PlusJakartaSans_700Bold" }}>
                        45 minutes
                      </Text>{" "}
                      (15 mins faster than estimated), saving you{" "}
                      <Text style={{ fontFamily: "PlusJakartaSans_700Bold" }}>
                        PKR 250
                      </Text>{" "}
                      in additional labor overhead. High efficiency observed!
                    </Text>
                  </View>

                  {/* Detailed Invoice Summary */}
                  <View style={styles.ratingInvoiceCard}>
                    <Text style={styles.ratingInvoiceTitle}>
                      Service Receipt Summary
                    </Text>
                    <View style={styles.ratingInvoiceRow}>
                      <Text style={styles.ratingInvoiceLabel}>
                        {ratingBooking.serviceName}
                      </Text>
                      <Text style={styles.ratingInvoiceValue}>
                        {ratingBooking.price}
                      </Text>
                    </View>
                    <View style={styles.ratingInvoiceRow}>
                      <Text style={styles.ratingInvoiceLabel}>
                        Agentic Matching Fee
                      </Text>
                      <Text style={styles.ratingInvoiceValue}>
                        PKR 0 (Promo)
                      </Text>
                    ...
                    <View
                      style={[
                        styles.ratingInvoiceRow,
                        styles.ratingInvoiceTotalRow,
                      ]}
                    >
                      <Text style={styles.ratingInvoiceTotalLabel}>
                        Total Paid
                      </Text>
                      <Text style={styles.ratingInvoiceTotalValue}>
                        {ratingBooking.price}
                      </Text>
                    </View>
                  </View>
          ...
          (() => {
            ...
            return (
              <ScrollView
                style={styles.trackScreenContainer}
              ...
              >
                  ...
                  <View style={styles.fullscreenMapContainer}>
                    ...
                    <View style={styles.fullscreenMapEtaCard}>
                      <View style={styles.fullscreenMapEtaHeader}>
                        ...
                        />
                        <Text style={styles.fullscreenMapEtaTitle}>
                      ...
                      <View style={styles.fullscreenMapEtaSubRow}>
                        <Text style={styles.fullscreenMapEtaValue}>
                          ETA: 12 minutes
                        </Text>
                        <Text style={styles.fullscreenMapEtaDist}>
                          • 2.4 km remaining
                        </Text>
                      </View>
                    </View>
                ...
                >
                  ...
                  <View style={styles.trackEtaBadge}>
                    ...
                    <View style={{ flex: 1 }}>
                      <Text style={styles.trackEtaTitle}>
                        Ahmed Khan is en route
                      </Text>
                      <Text style={styles.trackEtaSubtitle}>
                        ETA: 12 mins • 2.4 km away
                      </Text>
                    </View>
                  </View>
                </TouchableOpacity>
                ...
                <View style={styles.trackTechnicianCard}>
                  <View style={styles.trackTechHeader}>
                    ...
                    <View style={{ flex: 1, marginLeft: 12 }}>
                      ...
                      <Text style={styles.trackTechSub}>
                        {trackingBooking
                          ? `Order ID: ${trackingBooking.id}`
                          : "Order ID: #KG-482910"}
                      </Text>
                      <Text style={styles.trackTechService}>
                        {trackingBooking
                          ? trackingBooking.service
                          : "AC Repair & Service"}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.trackActionsRow}>
                    ...
                    >
                      ...
                      <Text style={styles.trackActionTextSec}>
                        Call Technician
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                ...
                <View style={styles.trackTimelineCard}>
                  <Text style={styles.trackTimelineHeaderTitle}>
                    SERVICE PROGRESS
                  </Text>
                  ...
                  <View style={styles.trackTimelineWrapper}>
                    ...
                    <View style={styles.trackTimelineItem}>
                      ...
                      <View style={styles.trackTimelineContent}>
                        <Text style={styles.trackTimelineTitleDone}>
                          Confirmed
                        </Text>
                        <Text style={styles.trackTimelineSubtitleDone}>
                          Technician assigned at 10:30 AM
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.trackTimelineItem}>
                      ...
                      <View style={styles.trackTimelineContent}>
                        <Text style={styles.trackTimelineTitleActive}>
                          En Route
                        </Text>
                        <Text style={styles.trackTimelineSubtitleActive}>
                    ...
                    <View style={styles.trackTimelineItem}>
                      ...
                      <View style={styles.trackTimelineContent}>
                        <Text style={styles.trackTimelineTitlePending}>
                          In Progress
                        </Text>
                        <Text style={styles.trackTimelineSubtitlePending}>
                          Work will start upon arrival
                        </Text>
                      </View>
                    </View>
                    ...
                    {/* Item 4: Completed */}
                    <View
                      style={[styles.trackTimelineItem, { marginBottom: 0 }]}
                    >
                      <View style={styles.trackTimelineIndicatorContainer}>
                        <View style={styles.trackTimelineBulletPending} />
                      </View>
                ...
                <View style={styles.trackSupportCard}>
                  ...
                  <Text style={styles.trackSupportText}>
                    Need help?{" "}
                    <Text style={styles.trackSupportLink} onPress={() => {}}>
                      Contact Support
                    </Text>{" "}
                    available 24/7 for active service bookings.
                  </Text>
                </View>
              </ScrollView>
            );
                ...
                >
                  ...
                  <View style={styles.invoiceStatusSection}>
                    ...
                    <Text style={styles.invoiceDateText}>
                      Date: {selectedInvoiceBooking.date}
                    </Text>
                  </View>
                  ...
                  <View style={styles.invoiceCard}>
                    <View style={styles.invoiceServiceHeader}>
                      ...
                      <View style={styles.invoiceServiceMeta}>
                        <Text style={styles.invoiceServiceName}>
                          {selectedInvoiceBooking.service}
                        </Text>
                        <Text style={styles.invoiceProviderName}>
                          {selectedInvoiceBooking.provider}
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.invoiceScheduleRow}>
                      <View style={styles.invoiceScheduleItem}>
                        <MaterialIcons name="event" size={16} color="#6e7979" />
                        <Text style={styles.invoiceScheduleText}>
                      ...
                      <View style={styles.invoiceScheduleItem}>
                        ...
                        />
                        <Text style={styles.invoiceScheduleText}>
                          {selectedInvoiceBooking.time.split(" - ")[0]}
                        </Text>
                      </View>
                    </View>
                  </View>
                  ...
                  {/* Billing Breakdown */}
                  <View style={styles.invoiceCard}>
                    <Text style={styles.invoiceBillingTitle}>
                      BILLING DETAILS
                    </Text>
                    <View style={styles.invoiceBillingRow}>
                      <Text style={styles.invoiceBillingLabel}>
                        Base Service Fee
                      </Text>
                      <Text style={styles.invoiceBillingValue}>
                        {invoiceDetails.baseFee}
                      </Text>
                    </View>
                    <View style={styles.invoiceBillingRow}>
                      <Text style={styles.invoiceBillingLabel}>
                    ...
                    <View style={styles.invoiceBillingRow}>
                      <View style={styles.invoicePromoLabelContainer}>
                        ...
                        <Text
                          style={[
                            styles.invoiceBillingLabel,
                            { color: "#005c3e", marginLeft: 4 },
                          ]}
                        >
                          Discount (Promo)
                        </Text>
                  ...
                  <View style={styles.invoiceCard}>
                    <View style={styles.invoicePaymentRow}>
                      <View style={styles.invoicePaymentLeft}>
                        ...
                        <View>
                          <Text style={styles.invoicePaymentTitle}>
                            PAYMENT METHOD
                          </Text>
                  ...
                  {!notifications.some((n) => n.unread) && (
                    <View style={styles.caughtUpCard}>
                      ...
                      <Text style={styles.caughtUpSubtitle}>
                        No new notifications at the moment. We'll alert you when
              ...
              {isLoadingSessions ? (
                ...
                sessions.map((session) => (
                    ...
                    onPress={async () => {
                      ...
                      try {
                        ...
                        if (history && history.messages) {
                          const formattedMsgs: Message[] = history.messages.map(
                            (m, i) => ({
                              id: `hist_${i}`,
                  ...
                  >
                    ...
                    <Text style={styles.bookingServiceTitle}>
                      {session.service_type || "General Inquiry"}
                    </Text>
                    <View style={styles.bookingCardDivider} />
                    <View style={styles.bookingScheduleRow}>
                      <View
            ...
            <View style={styles.bottomNav}>
              ...
              >
                <MaterialIcons
                  name="home"
                  size={24}
                  color={activeTab === "home" ? "#00595c" : "#3e4949"}
                />
                <Text
                  style={[
                    styles.navText,
                    activeTab === "home" && { color: "#00595c" },
                  ]}
                >
                  Home
                </Text>
              ...
              >
                <MaterialIcons
                  name="event-note"
                  size={24}
                  color={activeTab === "bookings" ? "#00595c" : "#3e4949"}
                />
                <Text
                  style={[
                    styles.navText,
                    activeTab === "bookings" && { color: "#00595c" },
                  ]}
                >
                  My Bookings
                </Text>
              ...
              >
                <MaterialIcons
                  name="chat"
                  size={24}
                  color={activeTab === "chats" ? "#00595c" : "#3e4949"}
                />
                <Text
                  style={[
                    styles.navText,
                    activeTab === "chats" && { color: "#00595c" },
                  ]}
                >
                  Chats
                </Text>
              ...
              >
                <View style={{ position: "relative" }}>
                  <MaterialIcons
                    ...
                    size={24}
                    color={
                      activeTab === "notifications" ? "#00595c" : "#3e4949"
                    }
                  />
                  {notifications.some((n) => n.unread) && (
                    <View style={styles.navBarBadge} />
                ...
                <Text
                  style={[
                    styles.navText,
                    activeTab === "notifications" && { color: "#00595c" },
                  ]}
                >
                  Notifications
                </Text>
              ...
              >
                <MaterialIcons
                  name="person"
                  size={24}
                  color={activeTab === "profile" ? "#00595c" : "#3e4949"}
                />
                <Text
                  style={[
                    styles.navText,
                    activeTab === "profile" && { color: "#00595c" },
                  ]}
                >
                  Profile
                </Text>
      ...
      <ChatBottomSheet
        ...
        setMessages={
          chatProviderMode ? setProviderMessages : setAssistantMessages
        }
              ...
              {confirmDialog.iconName && (
                <View
                  style={[
                    ...
                    { backgroundColor: confirmDialog.iconColor + "15" },
                  ]}
                >
                  <MaterialIcons
                    name={confirmDialog.iconName as any}
                    size={32}
          ...
          <View style={styles.locModalContent}>
            <View style={styles.locModalHeader}>
              ...
              <Text style={styles.locModalDescription}>
                Karigar.ai needs your location to search for active specialists
                and technicians nearest to you.
              </Text>
            </View>

            <View style={styles.locInstructionsContainer}>
              <Text style={styles.locInstructionTitle}>
                How to enable permissions:
              </Text>

              <View style={styles.locStepRow}>
                <View style={styles.locStepNumber}>
                  <Text style={styles.locStepNumberText}>1</Text>
                </View>
                <Text style={styles.locStepText}>
                  Tap the{" "}
              ...
              <View style={styles.locStepRow}>
                <View style={styles.locStepNumber}>
                  <Text style={styles.locStepNumberText}>2</Text>
                </View>
                <Text style={styles.locStepText}>
                  Select <Text style={{ fontWeight: "bold" }}>Permissions</Text>{" "}
                  in App settings.
                </Text>
              </View>
              ...
              <View style={styles.locStepRow}>
                <View style={styles.locStepNumber}>
                  <Text style={styles.locStepNumberText}>3</Text>
                </View>
                <Text style={styles.locStepText}>
                  Tap <Text style={{ fontWeight: "bold" }}>Location</Text> and
                  choose{" "}
